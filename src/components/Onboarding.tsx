          ...
          {step === 2 && (
            <div className="space-y-6">
              <div className="text-center mb-8">
                ...
                <h3 className="text-2xl font-poppins font-semibold text-white mb-2">Academic Information</h3>
                <p className="text-gray-300">What's your current academic status?</p>
              </div>
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  {['10', '12'].map((classLevel) => (
                    ...
                    >
                      <div className="text-2xl font-bold mb-2">Class {classLevel}</div>
          ...
          {step === 3 && (
            <div className="space-y-6">
              <div className="text-center mb-8">
                ...
                <h3 className="text-2xl font-poppins font-semibold text-white mb-2">Location Details</h3>
                <p className="text-gray-300">Help us find colleges near you</p>
              </div>
          ...
          {step === 4 && (
            <div className="space-y-6">
              <div className="text-center mb-8">
                ...
                <h3 className="text-2xl font-poppins font-semibold text-white mb-2">Your Interests</h3>
